  ...
  <div class="app-container">
        ...
        <div>
          ...
          <el-form-item label="支付方式:">
            <el-radio-group v-model="listQuery.pay_type" size="mini" @change="payTypeSelect()">
              ...
              <el-radio-button :label="2">线下充值</el-radio-button>
            </el-radio-group>
          </el-form-item>
          <el-form-item>
            <el-button
    ...
    <el-card style="margin-top: 20px">
      ...
      >
        ...
        <el-table-column label="赠送积分" align="center" :show-overflow-tooltip="true">
          <template slot-scope="{ row }">
...
export default {
  ...
  methods: {
    //提交订单备注
    submitProData() {
      setRechargeOrderRemark(this.form).then(res => {
        this.$message({
          message: '提交成功',
          type: 'success'
        })
    ...
    getList() {
      ...
      getRechargeOrderList(this.listQuery).then(response => {
